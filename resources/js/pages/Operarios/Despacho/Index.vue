...
<template>
    ...
    <div class="flex min-h-screen flex-1 flex-col gap-4 p-4 px-20" style="background-color: #F4F4F4;">
        ...
        <div class="max-w-md">
            <div class="flex gap-4 items-end">
                ...
                <button @click="buscarControlStock" :disabled="isLoadingBusqueda || !numeroSerie.trim()"
        ...
        <div class="flex gap-6 flex-1">
                        ...
                        <table class="w-full">
                            <thead class="bg-[#E1E5E9]">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">N° Serie
                                    </th>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Modelo
                                    </th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <TransitionGroup name="table-row" tag="div" class="contents">
                                    <tr v-for="item in controlStockItems" :key="item.id" :data-item-id="item.id"
                                        ...
                                        <td class="px-4 py-3 text-sm text-center">
                                            <button @click="eliminarControlStock(item)"
            ...
            <div class="w-1/2">
                <div class="bg-white shadow-sm overflow-hidden">
                    <div v-if="hasRemitosSeleccionados && modelosResumen.length > 0 && !isLoadingModelos"
                        ...
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <TransitionGroup name="fade-slide" tag="div" class="contents">
                                    <tr v-for="modelo in modelosResumen" :key="modelo.modelo_id"
                                        class="hover:bg-gray-50 transition-all duration-200" :class="{
                ...
                <Transition name="fade-up" appear>
                    <div v-if="hasControlStockItems && hasRemitosSeleccionados" class="mt-4 flex justify-end">
                        <button @click="procesarDespacho" :disabled="!puedeDespachar || isLoadingDespacho"
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-4 gap-6">
                <TransitionGroup name="remito-card" tag="div" class="contents">
                    <div v-for="remito in remitosParaDespacho" :key="remito.id"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex-shrink-0">
                                <div class="w-5 h-5 border-2 rounded flex items-center justify-center transition-all duration-200"
                                    ...
                                    <svg v-if="isRemitoSeleccionado(remito.id)" class="w-3 h-3 text-white"
                        ...
                        <div class="grid grid-cols-1 gap-1">
                            <div v-for="modelo in remito.modelos" :key="modelo.id"
