        ...
        <div class="flex gap-2">
          <div class="relative">
            <input
              ...
              style="border-color: #0D509C;"
              v-model="filtroNoOrden"
            />
          ...
          <button
            @click="open_filtros = !open_filtros"
          ...
          <div class="w-full flex items-center gap-6 flex-wrap">
            ...
            <div class="flex flex-col w-[200px] gap-2">
              ...
              <input 
                ...
                class="border border-neutral-200 rounded-md py-2 px-2"
              />
            </div>
        ...
        <table class="w-full bg-white overflow-hidden">
          <thead class="" style="background-color:  #E1E5E9;">
            <tr>
              ...
              <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">N° de orden</th>
              <th class="py-3 px-4 text-left text-sm font-medium text-gray-600 uppercase tracking-wider">Fecha de finalización</th>
              <th class="py-3 px-4 text-center text-sm font-medium text-gray-600 uppercase tracking-wider">Cant. productos</th>
          ...
          <tbody class="divide-y divide-gray-200">
            <tr v-for="item in filteredData" :key="item.id">
              ...
              <td class="py-3 px-4 text-center">
                <Link
                  :href="`/ordenes-fabricacion/${item.id}/edit`"
                  class="inline-block p-2 rounded-full hover:bg-gray-100"
                >
                  <svg width="8" height="14" viewBox="0 0 8 14" fill="none">
                    <path d="M1 1l6 6-6 6" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </Link>
              </td>
            </tr>
        ...
        <form @submit.prevent="submitForm">
          <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input 
                ...
                :min="fechaHoy"
                @change="updateFechaMinFinalizacion"
                required
              />
            </div>
            
            <div>
              <label for="fecha_finalizacion" class="block text-sm font-medium text-gray-700 mb-1">Fecha de finalización</label>
              <input 
                type="date" 
                id="fecha_finalizacion" 
                v-model="form.fecha_finalizacion" 
                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                :min="fechaMinFinalizacion"
                required
              />
            </div>
          </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                <div class="col-span-2">
                  ...
                  >
                    ...
                    <option v-for="m in modelos" :key="m.id" :value="m.id">{{ m.modelo }} - {{ m.nombre_modelo }}</option>
                  </select>
                </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200">
              ...
              <div class="p-0">
                ...
                <ul v-else class="divide-y divide-gray-200">
                  <li v-for="(item, index) in form.modelo_productos" :key="index" class="flex justify-between items-center p-3">
          ...
          <div class="flex justify-end space-x-3">
            ...
            <button 
              ...
              style="background-color: #0D509C;"
              :disabled="isSubmitting || form.modelo_productos.length === 0"
            >
