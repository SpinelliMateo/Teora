    ...
    <header 
        ...
        <div class="w-full flex items-center justify-between">
            ...
            <div @click="open_cerrar_sesion = !open_cerrar_sesion" class="flex items-center justify-center gap-2 cursor-pointer relative">
                ...
                >
                    <div v-if="open_cerrar_sesion" class="absolute top-8 right-0 bg-white py-2 px-4 w-40 rounded-lg shadow-lg z-50 overflow-hidden">
                        <Link 
                            method="post" 
                            :href="route('logout')" 
                            @click="handleLogout" 
